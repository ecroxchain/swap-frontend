...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `http://ecroxswap.com/images/tokens/${token.address[988207]}.png`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `http://ecroxswap.com/images/tokens/${token.address[988207]}.png`;
        const secondarySrc = `http://ecroxswap.com/images/tokens/${tokens[randomTokenIndex].address[988207]}.png`;
