describe('Swap', () => {
  ...
  it.skip('can swap ECROX for BUSD', () => {
    cy.get('#swap-currency-output .open-currency-select-button').click()
    cy.get('.token-item-0xb30ebc0Ec978472B4a500a717880fE4D8f8c3288').should('be.visible')
    cy.get('.token-item-0xb30ebc0Ec978472B4a500a717880fE4D8f8c3288').click({ force: true })
  ...
  it('should get input and output currency from url params', () => {
    cy.visit('/swap?inputCurrency=0xb30ebc0Ec978472B4a500a717880fE4D8f8c3288&outputCurrency=ECROX')
    cy.get('#swap-currency-input #pair').should('contain', 'BUSD')
    cy.get('#swap-currency-output #pair').should('contain', 'ECROX')
  })
