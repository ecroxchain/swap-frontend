...
export const INFO_CLIENT = 'https://graph-bridge.ecroxscan.com/subgraphs/name/secrox/exchange'
export const BLOCKS_CLIENT = 'https://graph-bridge.ecroxscan.com/subgraphs/name/secrox/blocks'
export const GRAPH_API_NFTMARKET = process.env.NEXT_PUBLIC_GRAPH_API_NFT_MARKET
export const GRAPH_HEALTH = 'https://graph-bridge.ecroxscan.com/index-node/graphql'
