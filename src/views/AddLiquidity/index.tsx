...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from '@danielvindax/ecroxswap-sdk'
import { Button, Text, AddIcon, CardBody, Message, useModal, TooltipText, useTooltip } from '@secrox/uikit'
  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB_: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        router.replace(`/add/${currencyIdA || 'ECROX'}/${newCurrencyIdB}`, undefined, { shallow: true })
      }
    },
