...
import { Text, Flex, Box, Radio, Skeleton, LinkExternal, ArrowForwardIcon, ArrowBackIcon } from '@secrox/uikit'
...
const TransactionTable: React.FC<{
  ...
  return (
    <Wrapper>
      ...
      <TableWrapper>
        <ResponsiveGrid>
          <Text color="#EC233B" fontSize="12px" bold textTransform="uppercase">
            {t('Action')}
          </Text>
        ...
        {transactions ? (
          <>
            ...
            <PageButtons>
              ...
              >
                <ArrowBackIcon color={page === 1 ? 'textDisabled' : '#EC233B'} />
              </Arrow>
              ...
              >
                <ArrowForwardIcon color={page === maxPage ? 'textDisabled' : '#EC233B'} />
              </Arrow>
            </PageButtons>
          </>
        ) : (
