          ...
          <Flex justifyContent="space-between" mb="16px" flexDirection={['column', 'column', 'row']}>
            <Breadcrumbs mb="32px">
              <NextLinkFromReactRouter to="/info">
                <Text color="#EC233B">{t('Info')}</Text>
              </NextLinkFromReactRouter>
              <NextLinkFromReactRouter to="/info/pools">
                <Text color="#EC233B">{t('Pools')}</Text>
              </NextLinkFromReactRouter>
              <Flex>
                ...
                <Box p="24px">
                  <Flex justifyContent="space-between">
                    <Flex flex="1" flexDirection="column">
                      <Text color="#EC233B" bold fontSize="12px" textTransform="uppercase">
                        {t('Liquidity')}
                      </Text>
                  ...
                  <Text color="#EC233B" bold mt="24px" fontSize="12px" textTransform="uppercase">
