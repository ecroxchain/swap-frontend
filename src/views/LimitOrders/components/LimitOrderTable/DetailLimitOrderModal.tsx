import { Button, Flex, Box, Modal, Text, ChevronRightIcon, InjectedModalProps, Tag, Spinner } from '@secrox/uikit'
...
export const DetailLimitOrderModal: React.FC<DetailLimitOrderModalProps> = ({ onDismiss, order, formattedOrder }) => {
  ...
  const orderDetails = (
    <>
      ...
      <LimitTradeInfoCard
        currentPriceExchangeRateText="0.002474 ECROX = 1 BUSD"
        currentPriceExchangeRateTextReversed="404.11169 BUSD = 1 ECROX"
