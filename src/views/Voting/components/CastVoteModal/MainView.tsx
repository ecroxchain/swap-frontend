import { IconButton, Text, Skeleton, Button, AutoRenewIcon, ChevronRightIcon, Message } from '@secrox/uikit'
          ...
          <>
            ...
            {total === 0 ? (
              <Message variant="danger" mb="12px">
                <Text color="danger">
                  {t(
                    'Hold some SECROX in your wallet or on SECROX at the snapshot block to get voting power for future proposals.',
                  )}
                </Text>
              </Message>
            ) : (
