...
import { Box, Button, Flex, Heading, LinkExternal } from '@secrox/uikit'
  ...
  return (
    <>
        ...
        <StyledHeaderInner>
          <div>
            ...
            <Heading scale="lg" color="#fff">
              {t('Buy and Sell NFTs on ECROX Smart Chain')}
            </Heading>
            {account && (
      ...
      <Gradient p="64px 0">
        ...
        {/* <LinkExternal href="https://docs.ecrox.com/contact-us/nft-market-applications" mx="auto" mt="16px">
