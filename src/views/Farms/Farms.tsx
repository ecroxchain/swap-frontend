...
import { Image, Heading, RowType, Toggle, Text, Button, ArrowForwardIcon, Flex, Link } from '@secrox/uikit'
  ...
  return (
    <FarmsContext.Provider value={{ chosenFarmsMemoized }}>
      <PageHeader background="#ffffff">
        <Heading as="h1" scale="xxl" color="#EC233B" mb="24px">
          {t('Farms')}
        </Heading>
        <Heading scale="lg" color="#141414">
      ...
      <Page>
          ...
          <ViewControls>
            ...
            <ToggleWrapper>
              <Toggle
                ...
                scale="sm"
              />
              <Text color="#141414"> {t('Staked only')}</Text>
            </ToggleWrapper>
            <FarmTabButtons hasStakeInFinishedFarms={stakedInactiveFarms.length > 0} />
          </ViewControls>
          <FilterContainer>
            <LabelWrapper>
              <Text color="#141414" textTransform="uppercase">{t('Sort by')}</Text>
              <Select
                options={[
                  {
                    label: t('Hot'),
            ...
            <LabelWrapper style={{ marginLeft: 16 }}>
              <Text color="#141414" textTransform="uppercase">{t('Search')}</Text>
        ...
        <div ref={observerRef} />
        {/*<StyledImage src="/images/decorations/3dpan.png" alt="SECROX illustration" width={120} height={103} />*/}
      </Page>
