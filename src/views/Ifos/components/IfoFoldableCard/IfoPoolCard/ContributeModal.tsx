...
const ContributeModal: React.FC<Props> = ({
  ...
  const label = currency === tokens.secrox ? t('Max. SECROX entry') : t('Max. token entry')
  ...
  // in v3 max token entry is based on ifo ecrox and hard cap limit per user minus amount already committed
      ...
      <ModalBody maxWidth="360px">
        ...
        <Box p="2px">
          ...
          <Text color="textSubtle" fontSize="12px" mb="24px">
            {t(
              'If you don’t commit enough SECROX, you may not receive any IFO tokens at all and will only receive a full refund of your SECROX.',
            )}
            <Link
              fontSize="12px"
              display="inline"
              href="https://docs.ecrox.com/products/ifo-initial-farm-offering"
              external
            >
              {t('Read more')}
            </Link>
