...
import { Box, Card, CardBody, CardHeader, Flex, HelpIcon, Text, useTooltip } from '@secrox/uikit'
...
export const cardConfig = (
  ...
  switch (poolId) {
    case PoolIds.poolBasic:
      if (meta?.version === 3.1) {
        const MSG_MAP = {
          needQualifiedNFT: t('Set PancakeSquad NFT as SECROX Profile avatar.'),
          needQualifiedPoints: t('Reach a certain SECROX Profile Points threshold.'),
        }
