        ...
        <StyledTokenContent justifyContent="space-between" alignItems="center">
          <Box ml="8px">
            ...
            <Text color="textSubtle" fontSize="14px">
              {t('Stake SECROX to participate in IFO')}
            </Text>
          </Box>
          <TokenPairImage width={64} height={64} primaryToken={tokens.secrox} secondaryToken={tokens.secrox} />
        </StyledTokenContent>
      </CardHeader>
      <StyledCardBody>
        <Message variant="warning" mb="37px">
          <Flex flexDirection="column">
            <Text mb="16px">
              {t(
                'This is the old IFO SECROX pool. Check out the brand new SECROX pool to learn how to earn SECROX rewards with higher APY while enjoying other benefits.',
              )}
            </Text>
            <Flex ml="-34px">
              <Button onClick={handleOnClick} width="100%">
                {isShowMigrationButton ? t('Migrate') : t('Go to new SECROX pool')}
              </Button>
            </Flex>
          </Flex>
        </Message>
        ...
        <Box mt="24px">
          <Flex alignItems="center" justifyContent="space-between">
            <Text fontSize="14px">{`${t('Recent SECROX profit')}:`}</Text>
            <Balance
              bold
              fontSize="14px"
