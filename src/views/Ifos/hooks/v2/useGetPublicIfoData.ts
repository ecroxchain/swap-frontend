...
// https://github.com/secrox/pancake-contracts/blob/master/projects/ifo/contracts/IFOV2.sol#L431
// 1,000,000,000 / 100
...
const useGetPublicIfoData = (ifo: Ifo): PublicIfoData => {
  ...
  const currencyPriceInUSD = ifo.currency === tokens.secrox ? cakePriceUsd : lpTokenPriceInUsd
