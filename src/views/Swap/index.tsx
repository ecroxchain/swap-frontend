                    ...
                    <AutoColumn justify="space-between">
                      <AutoRow justify={isExpertMode ? 'space-between' : 'center'} style={{ padding: '0 1rem' }}>
                        ...
                        >
                          <ArrowDownIcon
                            className="icon-down"
                            color={currencies[Field.INPUT] && currencies[Field.OUTPUT] ? '#EC233B' : 'text'}
                          />
                          <ArrowUpDownIcon
                  ...
                  <Box mt="0.25rem">
                    {swapIsUnsupported ? (
                      ...
                      <GreyCard style={{ textAlign: 'center', padding: '0.75rem' }}>
                        <Text color="white">{t('Insufficient liquidity for this trade.')}</Text>
                        {singleHopOnly && <Text color="white">{t('Try enabling multi-hop trades.')}</Text>}
                      </GreyCard>
                    ) : showApproveFlow ? (
                      <RowBetween>
                        <Button
