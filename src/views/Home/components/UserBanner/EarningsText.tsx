...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and SECROX pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and SECROX pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from SECROX pool', data)
  }
