...
import { ArrowForwardIcon, Button, Flex, Heading, Skeleton, Text } from '@secrox/uikit'
...
const PredictionCardContent = () => {
  ...
  const bnbWonText = t('$%bnbWonInUsd% in ECROX won so far', { bnbWonInUsd: '#placeholder#' })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="#280D5F" mb="40px">
          {t('Will ECROX price rise or fall? guess correctly to win!')}
        </Text>
      </Flex>
