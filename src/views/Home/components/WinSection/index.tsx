...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@secrox/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'SECROX card' },
    { src: 'green', alt: 'Green SECROX card with up arrow' },
    { src: 'red', alt: 'Red SECROX card with down arrow' },
    { src: 'top-right', alt: 'SECROX card' },
  ],
}
