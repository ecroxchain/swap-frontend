...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@secrox/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in SECROX prizes this round', { cakePrizeInUsd: cakePriceBusd.toString() })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with SECROX, win SECROX if your numbers match')}
        </Text>
      </Flex>
