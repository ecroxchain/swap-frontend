...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the SECROX Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 SECROX Bunny NFTs at the snapshot may also purchase one additional SECROX Squad NFT in the presale for each SECROX Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of SECROX spent on SECROX Squad NFTs will be burned as part of our weekly SECROX burn.')],
  },
  {
