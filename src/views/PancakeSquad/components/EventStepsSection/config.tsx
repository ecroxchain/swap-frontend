  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active SECROX Profile to buy Minting Tickets and mint a SECROX Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold DBCC'),
      bodyText: [t('Each NFT costs DBCC to mint. Remember you also need ECROX to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
    ...
    },
    {
      ...
      bodyText: [
        ...
        `04:00 UTC, Oct. 7 ${t(
          'Pre-sale: Wallets which held “Gen 0” SECROX Bunnies NFTs (bunnyID 0,1,2,3,4) at a snapshot taken some time between 12 and 2 hours before the presale begins can purchase one Squad Ticket per Gen 0 NFT.',
        )}`,
        `08:00 UTC, Oct. 7 ${t(
          'Public Sale: Any wallet with an active SECROX Profile can purchase up to 10 Squad Tickets, while stocks last.',
        )}`,
      ],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Claim Phase'),
      bodyText: [
        t('During this phase, any wallet holding a Squad Ticket can redeem their ticket to claim a SECROX Squad NFT.'),
      ],
      buttons: (
        <>
          {hasData && (
