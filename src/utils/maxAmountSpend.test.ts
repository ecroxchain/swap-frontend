...
describe('maxAmountSpend', () => {
  ...
  it('should has value when CurrencyAmount is ECROX and CurrencyAmount is higher than min ecrox', () => {
    expect(
      JSBI.greaterThan(
  ...
  it('should be 0 when CurrencyAmount is ECROX and CurrencyAmount is low', () => {
