...
import { Currency, currencyEquals, ETHER, Token } from '@danielvindax/ecroxswap-sdk'
...
export function useCurrency(currencyId: string | undefined): Currency | Token | null | undefined {
  const isBNB = currencyId?.toUpperCase() === 'ECROX' || currencyId?.toLowerCase() === GELATO_NATIVE
